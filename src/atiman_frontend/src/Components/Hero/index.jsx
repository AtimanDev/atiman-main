  ...
  return (
      ...
      <header className="hero__section">
        ...
        <div className="hero__section__right">
          ...
          >
           Connect with others, find support, and grow together.
          </motion.p>
          <form className="hero__section__form">
            <label htmlFor="chat-input-box" className="hero__section__input">
              <input
                type="email"
                name="chatMessage"
                id="chatMessage"
                placeholder="Hi, Im Ressy. What's your name?"
                className="hero__section__input--box"
              />
            </label>
            <button className="btn btn-shadow">Chat with Ressy</button>
          </form>
